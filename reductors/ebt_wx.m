...
%%% summary: Structured empirical cross-Gramian-based balanced truncation.
    ...
    [LP,~,RP] = balro(WX(1:discrete.nP,1:discrete.nP),config.rom_max);
    [LQ,~,RQ] = balro(WX(discrete.nP+1:end,discrete.nP+1:end),config.rom_max);
