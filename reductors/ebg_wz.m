...
%%% summary: Structured empirical non-symmetric-cross-Gramian-based balanced gains.
    ...
    [LP,SP,RP] = balro(WZ(1:discrete.nP,1:discrete.nP),config.rom_max);
    [LQ,SQ,RQ] = balro(WZ(discrete.nP+1:end,discrete.nP+1:end),config.rom_max);
