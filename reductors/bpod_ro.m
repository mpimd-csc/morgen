function ROM = bpod_ro(solver,discrete,scenario,config)
%%% project: morgen - Model Order Reduction for Gas and Energy Networks
%%% version: 0.9 (2020-11-24)
%%% authors: C. Himpe (0000-0003-2194-6754), S. Grundel (0000-0002-0209-6566)
%%% license: 2-Clause BSD (opensource.org/licenses/BSD-2-clause)
%%% summary: Structured balanced POD.

    global ODE;

    name = 'Structured Balanced POD (WR + WO)';
    fprintf('%s\n\n',name);
    ...
    [LP,~,RP] = bpod(WR(1:discrete.nP,1:discrete.nP),WO(1:discrete.nP,1:discrete.nP),config.rom_max);
    [LQ,~,RQ] = bpod(WR(discrete.nP+1:end,discrete.nP+1:end),WO(discrete.nP+1:end,discrete.nP+1:end),config.rom_max);
