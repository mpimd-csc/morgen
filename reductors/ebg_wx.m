function ROM = ebg_wx(solver,discrete,scenario,config)
%%% project: morgen - Model Order Reduction for Gas and Energy Networks
%%% version: 0.9 (2020-11-24)
%%% authors: C. Himpe (0000-0003-2194-6754), S. Grundel (0000-0002-0209-6566)
%%% license: 2-Clause BSD (opensource.org/licenses/BSD-2-clause)
%%% summary: Structured empirical cross-Gramian-based balanced gains.

    global ODE;

    name = 'Structured Empirical Balanced Gains (WX)';
    fprintf('%s\n\n',name);
    ...
    [LP,SP,RP] = balro(WX(1:discrete.nP,1:discrete.nP),config.rom_max);
    [LQ,SQ,RQ] = balro(WX(discrete.nP+1:end,discrete.nP+1:end),config.rom_max);
