function solution = cnab2(discrete,scenario,config)
%%% project: morgen - Model Order Reduction for Gas and Energy Networks
%%% version: 1.2 (2022-10-07)
%%% authors: C. Himpe (0000-0003-2194-6754), S. Grundel (0000-0002-0209-6566)
%%% license: BSD-2-Clause (opensource.org/licenses/BSD-2-clause)
%%% summary: 2nd order Crank-Nicolson / Adams-Bashforth solver.
    ...
    if isempty(Rs) || ...
       ...
       not(numel(AP) == discrete.nP + discrete.nQ)
        ...
        [AL,AU,AP] = lu(discrete.E(rtz) - (config.relax * config.dt * 0.5) * discrete.A,'vector');
    end%if
    ...
    for k = 2:K
        ...
        zk = config.dt * (1.5 * fpxk - 0.5 * fpxl + discrete.A * xk);
